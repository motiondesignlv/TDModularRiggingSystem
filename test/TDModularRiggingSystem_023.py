...
from TDModularRiggingSystem import Controller
from TDModularRiggingSystem import System
...
TDMRS  = System.ModularRiggingSystem()
...
AllCtlList    = All.setAllRigging(20,CtlScale)
RootCtlList   = Root.setRootRigging(TDMRS.getJointLabelType()[0,1],14,CtlScale)
#SwitchCtlList = Switch.setSwitchRigging(20)
SpineCtlList  = Spine.setSpineRigging(TDMRS.getSpineJoint(),17,CtlScale)
NeckCtlList   = Neck.setNeckRigging(TDMRS.getNeckJoint(),17,CtlScale)
"""
HeadCtlList   = Head.setHeadRigging(TDMRS.getJointLabelType()[0,8],TDMRS.getJointLabelType()[0,7],17)
"""
LFootCtlList  = Foot.setFootRigging([TDMRS.getJointLabelType()[1,2],TDMRS.getJointLabelType()[1,3],TDMRS.getJointLabelType()[1,4]],6,CtlScale)
RFootCtlList  = Foot.setFootRigging([TDMRS.getJointLabelType()[2,2],TDMRS.getJointLabelType()[2,3],TDMRS.getJointLabelType()[2,4]],13,CtlScale)
