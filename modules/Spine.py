...
class TDSpineRigging():
    ...
    def createSpineIKCtl(self,spineJoints,CtlColor,CtlScale):
        ...
        self.spineIKCtlGP = self.System.createGP(self.spineIKCtlOffset[0],"%s_Grp"%self.spineIKCtls[0])
    ...
    def createSpineIKCtlConnection(self,spineJoints):
        ...
        for spines in range(len(spineJoints)):
            if spines == 0:
                ...
                self.IKBlendC = cmds.parentConstraint(self.IKSpineJoint[spines],self.spineJoint[spines],mo=True)
                #cmds.parentConstraint(self.spineCtls[spines],self.IKSpineJoint[spines],mo=True)
                self.IKBlendCList.append(self.IKBlendC[0]+"."+self.IKSpineJoint[spines]+"W1")
    ...
    def createSpineRigConnectNull(self,spineJoints):
        ...
        self.spineJointGrp = cmds.group(self.spineJoint[0],self.FKSpineJoint[0],self.IKSpineJoint[0],name="%s_Joint_Grp"%spineJoints[0])
